...
class TestExtractFastHTML5Soup(TestReplaceWithBase):
    __test__ = True
    EXPECTED_VALUE1 = '<html><head></head><body><a>1</a><test2>1</test2><a>3</a><b>4</b></body></html>'
    EXPECTED_VALUE2 = '<html><head></head><body><a>1</a><test2>1</test2><a>3</a><test>4</test><b>4</b></body></html>'
